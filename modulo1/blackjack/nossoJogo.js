...
if(confirm('Quer iniciar uma nova rodada?')){
   ...
   console.log(`Usuário - cartas: ${usuario[0]} e ${usuario[2]} - pontuação ${somausuario}`);
   console.log(`Computador - cartas: ${computador[0]} e ${computador[2]} - pontuação ${somacomputador}`);
